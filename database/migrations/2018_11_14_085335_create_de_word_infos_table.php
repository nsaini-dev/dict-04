...
class CreateDeWordInfosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('de_word_infos', function (Blueprint $table) {
        ...
        Schema::table('de_word_infos', function (Blueprint $table) {
            $table->primary('de_word_id'); // PK
            $table->foreign('de_word_id')->references('id')->on('de_words'); // FK
    ...
    {
        Schema::dropIfExists('de_word_infos');
    }
}
